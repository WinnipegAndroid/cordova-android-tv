...
var MEDIA_PATH = appurl + '/static/media/';

var appname = "Space Rocks"; //app name (id) of this app
var appurl = "/var/www/www.cmdann.ca/SpaceRocks";
var staticurl = "./static/apps/space_rocks_"; //base path to your static files /static/apps/yourapp/
...
var GameCode = {
    ...
    projectileColor: '#1B70E0',
    enemyColors: [ '#A324ED', '#24ED27', '#ED2424', '#EDED24' ],
    shipColor: '#1B70E0',
    textColor: '#FFFFFF',
    outlineShapes: true,
    fillShapes: true,
    ...
    update: function() {
        ...
        if ( (this.SPACE || rightTrigger ) && this.canFire && this.projectiles.length < this.maxProjectiles ) {
